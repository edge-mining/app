...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("storage_nominal_capacity", sa.Float(), nullable=True),
        sa.Column("grid_contracted_power", sa.Float(), nullable=True),
    ...
    op.create_index(op.f("ix_energy_optimization_units_id"), "energy_optimization_units", ["id"], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f("ix_energy_optimization_units_id"), table_name="energy_optimization_units")
    op.drop_table("energy_optimization_units")
