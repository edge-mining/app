...
# Import the shared metadata and ensure all tables are registered
# This uses the imperative mapping approach with a shared registry
...
# This must happen before any migration operations
