...
const emit = defineEmits<{
  close: [];
  save: [provider: EnergyLoadHistoryProvider];
}>();
...
const formData = ref<EnergyLoadHistoryProvider>({
  name: "",
  adapter_type: EnergyLoadHistoryProviderAdapter.DUMMY,
  config: {},
  external_service_id: "",
});
  ...
  (isOpen) => {
    if (isOpen) {
      if (props.provider) {
        ...
        formData.value = {
          name: "",
          adapter_type: historyProviderStore.adapterTypes[0] || EnergyLoadHistoryProviderAdapter.DUMMY,
          config: {},
          external_service_id: "",
        };
      ...
      <div class="flex items-center justify-between mb-6">
        <div class="flex items-center gap-3">
          <div class="h-10 w-10 rounded-xl bg-base-200/60 flex items-center justify-center">
            <PhChartLine :size="22" class="text-sky-400" />
          </div>
          <h3 class="text-xl font-bold">
            {{ isEdit ? "Edit History Provider" : "Add History Provider" }}
          </h3>
        </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="form-control">
              ...
              >
                ...
                <option
                  v-for="adapterType in historyProviderStore.adapterTypes"
                  :key="adapterType"
                  :value="adapterType"
                >
        ...
        <div class="space-y-4">
          ...
          <div class="bg-base-200/50 rounded-xl p-4 border border-base-300/40">
            <ConfigSchemaForm
              ...
              :sensor-prefix="formData.adapter_type === EnergyLoadHistoryProviderAdapter.HOME_ASSISTANT_API"
            />
