...
| Method | Endpoint | Description | Frontend Service | Frontend Page | Status |
|--------|----------|-------------|------------------|---------------|---------|
| GET | `/notifiers` | Get list of all notifiers | ❌ Not implemented | - | ⚠️ TODO |
| POST | `/notifiers` | Create a new notifier | ❌ Not implemented | - | ⚠️ TODO |
| GET | `/notifiers/types` | Get available notifier types | ❌ Not implemented | - | ⚠️ TODO |
| GET | `/notifiers/types/{adapter_type}/config-schema` | Get config schema for notifier type | ❌ Not implemented | - | ⚠️ TODO |
| GET | `/notifiers/{notifier_id}` | Get specific notifier | ❌ Not implemented | - | ⚠️ TODO |
| PUT | `/notifiers/{notifier_id}` | Update a notifier | ❌ Not implemented | - | ⚠️ TODO |
| DELETE | `/notifiers/{notifier_id}` | Delete a notifier | ❌ Not implemented | - | ⚠️ TODO |
| POST | `/notifiers/{notifier_id}/test` | Test a notifier | ❌ Not implemented | - | ⚠️ TODO |
...
| Method | Endpoint | Description | Frontend Service | Frontend Page | Status |
|--------|----------|-------------|------------------|---------------|---------|
| GET | `/external-services` | Get list of all external services | ❌ Not implemented | - | ⚠️ TODO |
| POST | `/external-services` | Create a new external service | ❌ Not implemented | - | ⚠️ TODO |
| GET | `/external-services/types` | Get available service types | ❌ Not implemented | - | ⚠️ TODO |
| GET | `/external-services/types/{adapter_type}/config-schema` | Get config schema for service type | ❌ Not implemented | - | ⚠️ TODO |
| GET | `/external-services/{service_id}` | Get specific service | ❌ Not implemented | - | ⚠️ TODO |
| PUT | `/external-services/{service_id}` | Update a service | ❌ Not implemented | - | ⚠️ TODO |
| DELETE | `/external-services/{service_id}` | Delete a service | ❌ Not implemented | - | ⚠️ TODO |
